...
module.exports.getAddressCoordinates = async (address) => {
    try {
        ...
        const url = `https://maps.gomaps.pro/maps/api/place/textsearch/json?query=${encodedAddress}&key=${apiKey}`;
...
module.exports.getDistanceAndTime = async (from, to) => {
    ...
    try {
        ...
        const url = `https://maps.gomaps.pro/maps/api/distancematrix/json?origins=${from}&destinations=${to}&key=${apiKey}`;
        const response = await axios.get(url);
